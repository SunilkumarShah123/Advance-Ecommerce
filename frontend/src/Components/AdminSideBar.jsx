  ...
  return (
    <div className='bg-dark text-light sidebar'>
      <div className='text-center p-3 border-bottom'>
        <img src="images/admin-logo.jpeg" className='img-fluid rounded-circle' alt="admin-logo" width="70px" />
      ...
      <div className='list-group list-group-flush'>
        ...
        <button onClick={() => toggleFunc('category')} className='list-group-item list-group-item-action bg-dark text-light border-0'>
        ...
        {openMenu.category && (
          <div>
            <Link to={'/add-category'} className='list-group-item list-group-item-action bg-dark text-light border-0'>
              <FaPlusCircle className='me-2' /> Add Category
            </Link>
            <Link to={'/manage-category'} className='list-group-item list-group-item-action bg-dark text-light border-0'>
              <FaListAlt className='me-2' /> Manage Category
            </Link>
          </div>
        )}

        <button onClick={() => toggleFunc('food')} className='list-group-item list-group-item-action bg-dark text-light border-0'>
        ...
        <button onClick={() => toggleFunc('Orders')} className='list-group-item list-group-item-action bg-dark text-light border-0'>
          <FaEdit className='me-2' />
