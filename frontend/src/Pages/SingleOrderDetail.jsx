...
import { FaReceipt, FaMapMarkerAlt, FaFileInvoice, FaCross, FaDumpster, FaTrash } from "react-icons/fa";
        ...
        <div className="row">
            ...
            <div className="card shadow-sm p-3">
              <div className="row align-items-center">
                ...
                <div className="col-md-4">
                  <img
                    src={`http://localhost:8000/${orderItems?.food?.image}`}
                    alt=""
                ...
                <div className="col-md-8">
                  ...
                  <h5>{orderItems?.food?.item_name}</h5>

                  <p className="text-muted">
                    {orderItems?.food?.item_description}
                  </p>

                  <p>
                    <strong>Price:</strong> ₹ {orderItems?.food?.item_price}
                  </p>

                  <p>
                    <strong>Quantity:</strong> {orderItems?.quantity}
                  </p>
          ...
          <div className="col-md-4">
            <div className="card shadow-sm p-4">
              ...
              <p>
                <strong>Total:</strong> ₹ {orderItems?.total_price}
              </p>

              <a href={`http://localhost:8000/api/invoices/${order_number}/`} className="btn btn-primary">
